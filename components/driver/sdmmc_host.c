...
static void sdmmc_host_set_clk_div(int div)
{
    ...
    // Make sure 160 MHz source clock is useddfrff
    ...
    #warning TIMS SDMMC PATCH
    SDMMC.clock.phase_dout = 1; //inout_clock_phase;
    SDMMC.clock.phase_din =  6; //inout_clock_phase;
